...
export const TailWindColorThemeClasses: ITailWindColorThemeClasses = {
  ...
  BTN_SECONDARY_BORDER:
    "bg-transparent border-cyan-900 text-slate-950 dark:border-cyan-700 dark:text-white hover:bg-cyan-900 dark:hover:bg-cyan-700 border-2",
  BTN_DANGER: "bg-rose-700 dark:text-white",
