...
export function PopoverListItemButton({
  text,
  onClick,
}: {
  text: string;
  ...
  return (
    <div className="p-3">
      <Popover.Button className="block w-full rounded-lg px-3 py-2 transition hover:bg-white/5">
        <p
          className={`font-semibold ${tw.TEXT_PRIMARY} w-full text-center`}
          onClick={onClick}
        >
          {text}
        </p>
